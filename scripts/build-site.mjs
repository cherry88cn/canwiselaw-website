...
const zhPages = {
  home:`<section class="hero"><div class="eyebrow">中英双语法律服务</div><h1>值得信赖的专业法律服务</h1><p>CanWise Law 为个人、家庭、创业者及企业提供加拿大移民法、商业与公司法及家庭法服务。我们以中文或英文清晰说明法律风险、证据要求、可行方案及下一步安排。</p>${zhButton}</section>${zhCards([['移民法','处理各类申请、拒签、上诉、联邦法院司法审查及强制令申请。','<a href="immigration-law/">了解更多 →</a>'],['商业与公司法','协助公司设立、股东及合伙协议、商业租赁、合同和交易事项。','<a href="business-commercial-law/">了解更多 →</a>'],['家庭法','就分居、离婚、子女、抚养、财产及家庭协议提供务实建议。','<a href="family-law/">了解更多 →</a>']])}<section class="soft"><div class="split"><div><div class="eyebrow">我们的理念</div><h2>理解文化背景的法律服务</h2></div><div><p>我们使用中文和英文沟通，以清楚易懂的方式解释法律选择、程序和下一步安排。</p><p>每项委托均根据具体事实单独评估，并重视材料准备、证据组织和持续沟通。</p></div></div></section>${zhCta('安心开始处理您的法律事务','预约咨询，获得清晰、系统并针对您具体情况的法律建议。')}`,
  ...
  'practice-areas':`${zhHero('主要法律领域','专业法律服务领域','我们以清晰沟通和充分准备，为每位客户提供切合实际的法律服务。')}${zhCards([['移民法','申请、拒签、上诉、司法审查、强制令、商业移民、家庭团聚及临时居民事务。','<a href="../immigration-law/">查看移民法服务 →</a>'],['商业与公司法','公司设立、合伙、公司治理、股东协议、商标、商业租赁及合同。','<a href="../business-commercial-law/">查看商业法服务 →</a>'],['家庭法','针对每位客户的具体情况，就家庭法问题提供清楚、务实的法律建议。','<a href="../family-law/">查看家庭法服务 →</a>']])}<section class="soft"><h2>我们的工作方式</h2><div class="steps"><article><b>01</b><h3>初步咨询</h3><p>了解需求，并说明可能的法律路径。</p></article><article><b>02</b><h3>制定策略</h3><p>确定方案、程序预期和下一步。</p></article><article><b>03</b><h3>严谨执行</h3><p>重视沟通、证据和文件准备。</p></article><article><b>04</b><h3>结果与复盘</h3><p>协助完成事项并说明结果。</p></article></div></section>${zhCta()}`,
  'immigration-law':`${zhHero('加拿大移民法律服务','移民事务需要法律策略时','为复杂申请、拒签、上诉及联邦法院程序提供法律服务。')}${zhCards([['临时居民','访问签证、学签、工签、毕业工签、身份延期及恢复、父母及祖父母超级签证。'],['永久居民与公民','快速通道、省提名、商业移民、配偶及子女团聚、父母及祖父母团聚、公民申请。'],['移民诉讼与上诉','拒签分析、程序公正信、移民上诉庭上诉、联邦法院司法审查、延误强制令及暂缓遣返。']])}<section class="soft"><h2>我们的重点</h2><p>许多客户曾经被拒签，或其情况需要复杂法律分析、书面陈述和诉讼代理。我们会识别法律与证据问题，并根据事实制定可行策略。本所专注于移民与公民事务，不承办难民法案件或法律援助证书案件。</p></section>${zhCta('咨询移民律师','请携带相关决定、申请记录及重要往来文件，以便评估。')}`,
  ...
  'judicial-review':`${zhHero('移民诉讼与上诉','联邦法院司法审查','当移民或难民决定不合理、存在法律错误或程序不公时，可申请由联邦法院审查。')}${zhCards([['法院审查什么','理由是否回应关键证据并具备合理分析；程序是否公平；是否适用正确法律标准；重要证据是否被忽略或严重误解。'],['申请期限','加拿大境内事项通常为获知决定后 15 日；境外事项通常为 60 日。延期由法院酌情决定，不应假定一定获准。'],['可能结果','法院可驳回申请，或撤销原决定并发回重新决定。法院通常不会直接批准签证、许可或永久居民申请。']])}<section class="soft"><h2>基本程序</h2><p>先提交并送达准许申请及司法审查申请；申请人提交记录和法律论证；被申请人可回应，申请人可回复。法院先决定是否准许进入听证。获准后，法院安排听证并听取口头陈述。</p></section>${zhCta('评估司法审查','请尽快提供决定、收到日期及完整申请材料，以评估期限和法律依据。')}`,
...
zhPages['immigration-fees']=zhFeeTable('移民法律服务费',[
 ...
 ['拒签、延误与诉讼', [['复议请求','从 $1,500 起','书面请求及支持陈述'],['程序公正信回复','从 $2,500 起','回复及法律陈述'],['联邦法院司法审查','从 $6,000 起','起价，范围以委托协议为准'],['延误强制令申请','从 $5,000 起','起价，范围以委托协议为准'],['IAD 上诉','从 $7,000 起','起价'],['联邦法院暂缓执行动议','从 $8,000 起','起价']]]
]);
...
const zhTitles = {
  ...
  'legal-consultation':'中文法律咨询｜CanWise Law', 'judicial-review':'联邦法院司法审查｜CanWise Law',
...
const zhDescriptions = {
  ...
  'immigration-law':'加拿大移民申请、拒签、上诉、司法审查及强制令的中文法律服务。',
  ...
  'judicial-review':'加拿大移民决定的联邦法院司法审查、期限、程序及可能结果。',
